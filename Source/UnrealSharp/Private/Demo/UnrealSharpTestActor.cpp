...
#include "Demo/UnrealSharpTestActor.h"

#include "UnrealSharpSubsystem.h"


// Sets default values
AUnrealSharpTestActor::AUnrealSharpTestActor()
{
 ...
 */
void AUnrealSharpTestActor::BeginPlay()
{
 ...
 * done correctly.
 */
void AUnrealSharpTestActor::Tick(float DeltaTime)
{
